...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-b border-slate-200 dark:border-gray-800 transition-colors">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 w-full gap-2">
          
          {/* TOP-LEFT LOGO/HOME ICON & ACTIVE HOUSE DROPDOWN TRIGGER */}
          <div className="flex items-center gap-2 sm:gap-3 min-w-0 shrink-0">
            {/* PERMANENT TOP-LEFT LOGO BUTTON */}
            <button
            ...
            {/* ACTIVE HOUSE DROPDOWN TRIGGER BUTTON & FLOATING POPOVER */}
            {activeHouse && (
              <div className="relative inline-block text-left shrink-0" ref={houseMenuRef}>
                <button
                  type="button"
                  onClick={() => setHouseMenuOpen(!houseMenuOpen)}
                  aria-expanded={houseMenuOpen}
                  className="inline-flex items-center gap-1.5 bg-slate-100 dark:bg-gray-800 px-2.5 py-1.5 rounded-xl border border-slate-200 dark:border-gray-700 text-xs font-extrabold text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-gray-700 transition cursor-pointer shadow-2xs max-w-[120px] xs:max-w-[160px] sm:max-w-[200px]"
                >
                ...
                {/* FLOATING HOUSE MENU DROPDOWN OVERLAY (DOES NOT ALTER NAVBAR FLEX LAYOUT) */}
                {houseMenuOpen && (
                  <div className="absolute left-0 top-full mt-2 w-72 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-gray-700 py-3 px-3.5 z-50 space-y-3 transition-all animate-in fade-in slide-in-from-top-2">
                    ...
                    <div className="pb-2 border-b border-slate-100 dark:border-gray-700 space-y-2">
                      ...
                      <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 dark:bg-gray-700/60 border border-slate-200 dark:border-gray-600">
                        <div className="text-[11px] font-mono">
                          <span className="text-slate-400 font-sans mr-1">House Code:</span>
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-white dark:bg-gray-600 text-indigo-700 dark:text-indigo-300 font-mono text-[10px] font-extrabold border border-slate-200 dark:border-gray-500 shadow-2xs hover:bg-indigo-50 dark:hover:bg-gray-500 transition cursor-pointer shrink-0"
                        >
          ...
          {/* DESKTOP NAVIGATION LINKS (DESKTOP/TABLET: >= md) */}
          {activeHouse && (
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="md:hidden p-1.5 sm:p-2 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-100 dark:hover:bg-gray-800 rounded-xl transition shrink-0 focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
            >
      ...
      {/* Mobile Drawer / Overlay Navigation (< md) */}
      {mobileMenuOpen && (
